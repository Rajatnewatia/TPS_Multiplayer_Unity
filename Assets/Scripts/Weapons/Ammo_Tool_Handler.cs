...
public class Ammo_Tool_Handler : MonoBehaviour {
	...
	public Ammo_Tool currentWeapon;
	public List<Ammo_Tool> weaponsList = new List<Ammo_Tool>();
	...
	void Animate()
	{
		...
		{
		case Ammo_Tool.WeaponType.Pistol:
			weaponType = 1;
			break;
		case Ammo_Tool.WeaponType.Rifle:
			weaponType = 2;
			break;
		}
	}
